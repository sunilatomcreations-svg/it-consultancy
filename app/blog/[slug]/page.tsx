  ...
  return (
    <div className="min-h-screen bg-[#F6F1EB]">
      ...
      <div className="container mx-auto px-4 pt-20">
        <Link href="/resources" className="inline-flex items-center gap-2 text-gray-700 hover:text-[#F97316] transition-colors font-medium">
          <ArrowLeft size={18} />
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              {post.content.split('\n').map((paragraph, index) => {
                if (paragraph.startsWith('## ')) {
                  return (
                    <h2 key={index} className="font-bold text-2xl mt-10 mb-4 text-gray-900">
                      {paragraph.replace('## ', '')}
                    </h2>
                  );
                }
                if (paragraph.startsWith('### ')) {
                  return (
                    <h3 key={index} className="font-semibold text-xl mt-8 mb-3 text-gray-900">
                      {paragraph.replace('### ', '')}
                    </h3>
                  );
                }
              ...
              {relatedPosts.map((relatedPost) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-semibold text-lg mt-2 group-hover:text-[#F97316] transition-colors">
                      {relatedPost.title}
                    </h3>
                  </div>
                </Link>
