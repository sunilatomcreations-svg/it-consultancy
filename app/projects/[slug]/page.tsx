    ...
    return (
      <div className="min-h-screen bg-[#F6F1EB] flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/portfolio">
            <button className="bg-[#F97316] text-white font-semibold rounded-full px-6 py-2 hover:opacity-90 transition-opacity">
              Back to Portfolio
            </button>
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#F6F1EB]">
      ...
      <div className="container mx-auto px-4 pt-20">
        <Link href="/portfolio" className="inline-flex items-center gap-2 text-gray-700 hover:text-[#F97316] transition-colors font-medium">
          <ArrowLeft size={18} />
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <span className="text-[#F97316] font-semibold text-sm tracking-wider uppercase mb-4 block">
                {project.category}
              </span>
              ...
              <div className="flex flex-wrap gap-2">
                {project.tags.map((tag) => (
                  <span key={tag} className="px-4 py-2 rounded-full bg-gray-100 text-gray-800 text-sm font-medium">
                    {tag}
                  </span>
                ))}
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
              {/* Challenge */}
              <div>
                <h2 className="font-bold text-2xl mb-4">The Challenge</h2>
              ...
              {/* Solution */}
              <div>
                <h2 className="font-bold text-2xl mb-4">Our Solution</h2>
                <p className="text-gray-600 leading-relaxed">
                  {project.solution}
                </p>
              </div>
              ...
              {/* Results */}
              <div>
                <h2 className="font-bold text-2xl mb-4">Results Achieved</h2>
                <ul className="space-y-3">
                  {project.results.map((result, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <CheckCircle className="text-[#F97316] flex-shrink-0 mt-1" size={18} />
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg sticky top-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech) => (
                    <span key={tech} className="px-3 py-1 rounded-full bg-gray-100 text-gray-800 text-xs">
                      {tech}
                    </span>
                  ))}
                </div>
                ...
                <div className="border-t border-gray-200 mt-6 pt-6">
                  <h3 className="font-bold text-lg mb-4">Start Your Project</h3>
                  <p className="text-sm text-gray-500 mb-4">
                    Interested in similar solutions for your business?
                  </p>
                  <button className="w-full bg-[#F97316] text-white font-semibold rounded-full px-4 py-2 hover:opacity-90 transition-opacity">
                    Contact Us
