...
const Gallery = () => {
  return (
    <div className="relative flex flex-col lg:flex-row gap-6 mx-auto">     

      {/* First 4 images as one grid */}
      <div className="relative">
        {/* First row: images 1 and 2 */}
        <div className="flex gap-3 lg:gap-6 mb-3 lg:mb-6">
          <div className="clip-card relative w-[420px] lg:w-[142px] xl:w-[242px] h-[124px] md:h-[224px] lg:h-[248.6px] bg-gray-200 rounded-lg overflow-hidden">
            <img
          ...
          <div className="clip-card relative w-[542px] lg:w-[385.2px] xl:w-[485.2px] h-[124px] md:h-[224px] lg:h-[248.6px] bg-gray-200 rounded-lg overflow-hidden">
            <img
      ...
      <div className="relative ">
        <div className="flex gap-3 lg:gap-6">
          <div className="clip-card relative bg-gray-200 rounded-lg overflow-hidden w-[542px] lg:w-[385.2px] xl:w-[485.2px] h-[260px] md:h-[520px]  lg:h-[520.33px] ">
            <img
          ...
          <div className="clip-card relative bg-gray-200 rounded-lg overflow-hidden w-[420px] lg:w-[85.2px] xl:w-[185.2px] h-[260px] md:h-[520px] lg:h-[520.33px]">
            <img
